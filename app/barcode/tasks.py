...
EMAIL_GROUPS = {
    ...
    'Testing_group': [
        ...
        'test6@mailinator.com',
        'test7@mailinator.com',
        'test8@mailinator.com',
        'test9@mailinator.com',
        'test10@mailinator.com',
        'test11@mailinator.com',
        'test12@mailinator.com',
        'test13@mailinator.com',
        'test14@mailinator.com',
        'test15@mailinator.com',
        'test16@mailinator.com',
        'test17@mailinator.com',
        'test18@mailinator.com',
