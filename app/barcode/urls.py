...
urlpatterns = [
    ...
    path('duplicate-batch-utility/', views.duplicate_batch_utility, name='duplicate-batch-utility'),
    path('supervisor-setup/', views.supervisor_setup_view, name='supervisor-setup'),
