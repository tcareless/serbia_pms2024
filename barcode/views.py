...
if post
  - get laser mark.  create if not existing without created date/time
  - does laser have duplicate scan entry
"""
...
def duplicate_scan_old(request):
            ...
            if form.is_valid():
                ...
                if lm.laser_mark:
                    ...
                    context = {
                        ...
                        'duplicate_scan_at': lm.laser_mark.scanned_at,
                    }
